...
export const ap = new Aprendiz("Juan Pablo","Resyes Gómez","avatar.png",30,NivelEducativo.POSGRADO,cursos);
...
function mostrarEstadisticas(aprendiz: Aprendiz):void{
    let numeroCertificados:number = aprendiz.darCusosCertificados();
